...
const ACADEMIC_SERVICES: AcademicServiceItem[] = [
  { titleKey: 'items.sciWriting.title', descKey: 'items.sciWriting.desc', detailKey: 'items.sciWriting.detail', featuresKey: 'items.sciWriting.features', icon: FileText, color: THEME_COLORS.primary, bgImage: ASSETS.cards.academicPaper },
  { titleKey: 'items.patent.title', descKey: 'items.patent.desc', detailKey: 'items.patent.detail', featuresKey: 'items.patent.features', icon: PieChartIcon, color: '#4b5bab', bgImage: ASSETS.cards.academicPatent },
  { titleKey: 'items.funding.title', descKey: 'items.funding.desc', detailKey: 'items.funding.detail', featuresKey: 'items.funding.features', icon: BarChart3, color: '#6366f1', bgImage: ASSETS.cards.academicFund },
  { titleKey: 'items.report.title', descKey: 'items.report.desc', detailKey: 'items.report.detail', featuresKey: 'items.report.features', icon: MessageSquare, color: '#8b5cf6', bgImage: ASSETS.cards.academicReport },
];
